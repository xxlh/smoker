...
;(function( $, window, document, undefined ) {
    ...
    function Waterfall(element, options) {
		...
		this.styleQueue = [];
		if (this.options.container) $window = $(this.options.container);
    ...
    Waterfall.prototype = {
        ...
        _getColumns : function() {
            var options = this.options,
                $container = options.container ? $(options.container) : (options.fitWidth ?  this.$element.parent() : this.$element),
        ...
        _requestData: function(callback) {
            ...
            $.ajax({
                ...
                success: function(data) {
					self.options.callbacks.dataLoaded(data, self.$loading);
        ...
        _nearbottom: function() {
            ...
            if (options.container) distanceFromWindowBottomToMinColBottom = $window.scrollTop() + $window.height() - ($(options.container).offsetTop?$(options.container).offsetTop:0) - minColHeight;
